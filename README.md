...
`bash` `coreutils` `gzip` `unzip` `wget` `xxd` `dmg2img`  `virtualbox` `ImageMagick`
...
* GNU `coreutils` ≥ 8.22, GNU `gzip` ≥ 1.5, Info-ZIP `unzip` ≥ v6.0, GNU `wget` ≥ 1.14, `xxd` ≥ 1.11, `ImageMagick` ≥ 6.9.10  
